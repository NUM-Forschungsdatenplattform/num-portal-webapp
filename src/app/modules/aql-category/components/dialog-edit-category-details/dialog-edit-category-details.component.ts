...
export class DialogEditCategoryDetailsComponent implements OnInit {
  @Input() data: Omit<IAqlCategoryApi, 'id'>
  @Output() closeDialog = new EventEmitter<Omit<IAqlCategoryApi, 'id'>>()
  ...
  ngOnInit(): void {
    this.categoryForm = this.formBuilder.group({
      nameDe: ['', [Validators.required, Validators.minLength(2)]],
