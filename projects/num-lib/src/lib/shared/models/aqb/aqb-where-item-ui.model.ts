...
import { IdHelperService } from '../../../core/helper/id-helper.service'
import { convertParameterInputToType } from '../../../core/utils/value-converter.utils'
import { IAqbComparisonOperatorNode } from '../archetype-query-builder/builder-request/aqb-comparison-operator-node.interface'
import { AqbComparisonOperator } from '../archetype-query-builder/builder-request/aqb-comparison-operator.enum'
import { AqbNodeType } from '../archetype-query-builder/builder-request/aqb-node-type.enum'
import { IAqbParameterNode } from '../archetype-query-builder/builder-request/aqb-parameter-node.interface'
import { IAqbSelectFieldNode } from '../archetype-query-builder/builder-request/aqb-select-field-node.interface'
import { IAqbSimpleValueNode } from '../archetype-query-builder/builder-request/aqb-simple-value-node.interface'
